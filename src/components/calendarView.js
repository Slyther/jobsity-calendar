            ...
            style={
              {
                ...
                color: tinycolor(reminder.reminderColor).getBrightness() < 128 ? 'white' : 'black'
              }
            }
    ...
    return (
      <Fragment>
        <Calendar
          ...
          tileContent={({ date, view }) => this.renderCustomTileContent({date, view})}
        />
        <ConfirmationModal
          deleteAll={true}
          showConfirmationModal={this.state.showConfirmationModal}
          onCancel={() => this.setState({showConfirmationModal: false, selectedDate: ''})}
